...
class FMModelOptions_fm extends FMAdminModel {
  ...
  public function save_db() {
    ...
    $fm_antispam_bot_validation = WDW_FM_Library(self::PLUGIN)->get('fm_antispam_bot_validation', '0', 'sanitize_text_field');
    $fm_antispam_nonce = WDW_FM_Library(self::PLUGIN)->get('fm_antispam_nonce', '0', 'sanitize_text_field');
    $fm_antispam_referer = WDW_FM_Library(self::PLUGIN)->get('fm_antispam_referer', '0', 'sanitize_text_field');
    $fm_block_ip_exceeded_limit = WDW_FM_Library(self::PLUGIN)->get('fm_block_ip_exceeded_limit', '0', 'sanitize_text_field');
    ...
    $fm_file_read = WDW_FM_Library(self::PLUGIN)->get('fm_file_read', 0, 'int');
